      ...
      <div class="collapse navbar-collapse text-right" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown menu">
            ...
            <ul style="background-color: #2d5d7d;" class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="{{ route('data_sekolah') }}">Data Sekolah</a></li>
              <li><a class="dropdown-item" href="{{ route('sejarah') }}">Sejarah Sekolah</a></li>
              <li><a class="dropdown-item" href="/guru_staff">Data Guru dan Staf</a></li>
            </ul>
          </li>
          <li class="nav-item title">
