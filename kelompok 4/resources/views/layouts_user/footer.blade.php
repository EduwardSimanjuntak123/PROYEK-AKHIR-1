...
<footer>
    <div class="container-fluid text-center ">
        <div class="row justify-content-between footer">
            ...
            <div class="col-5 col-md-3 col-lg-3 kanan">
                <h2 class="pb-2 mb-3 border-bottom border-warning">Ikuti Kami</h2>
                <div class="in">
                    <div class="icon">
                        <a href="https://www.facebook.com/smpn4balige"><i class="bi bi-facebook"></i><p>smpn4balige</p> </a>
                    </div>
                    <div class="icon">
                        <a href="https://www.youtube.com/@smpnegeri4balige339"><i class="bi bi-youtube"></i><p>smpnegeri4balige339</p> </a>
                    </div>
                    <div class="icon">
                        <a href="https://www.instagram.com/smpn4balige" style="display: inline-flex; justify-content:center">
            ...
            <div class="col-md-4 col-lg-4 tengah">
                <iframe
