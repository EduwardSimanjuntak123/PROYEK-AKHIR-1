...
@section('content')
    ...
    <div class="container-fluid person">
        <div class="row justify-content-md-center flex-wrap" style="background: rgba(217, 217, 217, 0.64); position: relative;">
            <div class="col-md-4 col-xl-4" style="position: relative;">
                <img src="{{ asset('img/berliana.png') }}" class="img-fluid" style="position: absolute; bottom: 0; width: 100%;">
            </div>
...
@foreach ($berita as $item)
                <div class="col-10 col-lg-5 news shadow">
                    ...
                    <div class="text-start" >
                        <a class="link" href="{{ route('berita.show' , ['id'=>$item->id]) }}"><h5 class="text-start" style="-webkit-line-clamp:2; display:-webkit-box; -webkit-box-orient:vertical; overflow:hidden;">{{ $item->judul }}</h5></a>
