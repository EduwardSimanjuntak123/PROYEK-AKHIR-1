            ...
            <tbody>
                ...
                <tr>
                    ...
                    <form action="{{ route('kritik.update', $kritik->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-sm {{ $kritik->ditampilkan ? 'btn-success' : 'btn-secondary' }}">
                    ...
                    <td>
                        ...
                        <form action="{{ route('kritik.destroy', $kritik->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus kritik ini?')">Hapus</button>
                        </form>
                    </td>
                    <td>
