    ...
    <div class="row">
        ...
        <div class="col-8 right">
            ...
            <div class="three">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3320.1418352102305!2d99.0469476716618!3d2.3261271552038028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x302e04f1116aadad%3A0xee0a9a7c9f1693f7!2sSMP%20Negeri%204%20BALIGE!5e0!3m2!1sid!2sid!4v1716953171828!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
</div>
...
<div class="container mb-5">
    ...
    <div class="mt-5">
        ...
        <div class="mb-4 p-5 shadow" style="background-color: #f8f9fa;">
            ...
            <div class="card-body">
                <form action="{{ route('kritik.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama (Optional)">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea class="form-control" name="isi_kritik" id="isi_kritik" rows="3" placeholder="masukkan ulasan anda terkait sekolah maupun website kami"></textarea>
                    </div>
